  ...
  layout: [
    ...
    },
    {
      ...
      items: [
        ...
        { question: 'Where do assets come from?', answer: 'Production pages should use Payload media or public Cloudflare R2 URLs configured through content and environment variables.' },
      ],
    },
  ],
}
